...
struct cmd_table {
    ...
    void                (*VTALoadBuffer2D)(VTACommandHandle, void *, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t,
                                            uint32_t, uint32_t, uint32_t, uint32_t, uint32_t);
    int                 (*VTAPushALUOp)(void **, int (*)(void *), void *, int);
    int                 (*VTAPushGEMMOp)(void **, int (*)(void *), void *, int);
    void                (*VTAStoreBuffer2D)(VTACommandHandle, uint32_t, uint32_t, void *, uint32_t, uint32_t, uint32_t, uint32_t);
    void                (*VTASynchronize)(VTACommandHandle, uint32_t);
