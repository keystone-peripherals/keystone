...
QEMU_FLAGS := -m $(QEMU_MEM) -smp $(QEMU_SMP) -display none \
                ...
                -append "console=ttyS0 ro root=/dev/vda cma=512M nohz_full=N isolcpus=N" \
                -netdev user,id=net0,net=192.168.100.1/24,dhcpstart=192.168.100.128,hostfwd=tcp::9821-:22 \
                -device virtio-net-device,netdev=net0 \
                -device virtio-rng-pci \
		-serial mon:stdio -serial file:/tmp/keystone-qemu.out
...
meta-debug:
	...
	gdb --args $(BUILDROOT_BUILDDIR)/host/bin/qemu-system-riscv64 $(QEMU_FLAGS)
