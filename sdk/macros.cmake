...
macro(add_exportable_function target_name scratch_size)
  # First, we need to compile the executable
  add_executable(${target_name}_sym ${ARGN})

  target_compile_options(${target_name}_sym PRIVATE
          -ffunction-sections -fdata-sections -mcmodel=medany -static-pie)

  # Link with gc-sections to strip out functionality we don't need
  get_sdk_dir(SDK_SRCDIR)
  target_link_options(${target_name}_sym PRIVATE -static-pie
          -T ${SDK_SRCDIR}/src/app/export_link.ld -Wl,-z,notext)

  # Define some important metadata through compile flags
  target_compile_definitions(${target_name}_sym PRIVATE
  ...
  add_custom_target(${target_name}_bin
          ...
          COMMAND ${CMAKE_STRIP} -o ${target_name}_bin ${target_name}_sym)
