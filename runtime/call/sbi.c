...
uintptr_t timestamp_exit, timestamp_return;
#define SBI_CALL(___ext, ___which, ___arg0, ___arg1,             \
  ...
  ({                                                             \
    ...
    __asm__ volatile("rdcycle %0" : "=r"(timestamp_exit)); \
    __asm__ volatile("ecall"                                     \
                     : "+r"(a0)                       \
                     : "r"(a0), "r"(a1), "r"(a2), "r"(a3), "r"(a4),       \
                       "r"(a5), "r"(a6), "r"(a7)                 \
                     : "memory");                                \
    __asm__ volatile("rdcycle %0" : "=r"(timestamp_return)); \
    a0;                                                          \
  })
...
sbi_call_enclave(int eid, int type, uintptr_t arg0, uintptr_t arg1, uintptr_t arg2, uintptr_t arg3) {
  ...
  return ({                                                             \
    register uintptr_t a0 __asm__("a0") = (uintptr_t)(eid);  \
    register uintptr_t a1 __asm__("a1") = (uintptr_t)(type);  \
    register uintptr_t a2 __asm__("a2") = (uintptr_t)(arg0);  \
    register uintptr_t a3 __asm__("a3") = (uintptr_t)(arg1);  \
    register uintptr_t a4 __asm__("a4") = (uintptr_t)(arg2);  \
    register uintptr_t a5 __asm__("a5") = (uintptr_t)(arg3);  \
    register uintptr_t a6 __asm__("a6") = (uintptr_t)(SBI_SM_CALL_ENCLAVE); \
    register uintptr_t a7 __asm__("a7") = (uintptr_t)(SBI_EXT_EXPERIMENTAL_KEYSTONE_ENCLAVE);   \
    __asm__ volatile("rdcycle %0" : "=r"(timestamp_exit)); \
    __asm__ volatile("ecall"                                     \
                     : "+r"(a1)                        \
                     : "r"(a0), "r"(a1), "r"(a2), "r"(a3), "r"(a4),       \
...
#ifdef USE_CALLEE_PROFILE
  SBI_CALL_1(SBI_EXT_EXPERIMENTAL_KEYSTONE_ENCLAVE, SBI_SM_RET_ENCLAVE, timestamp);
#else
